...
Status = 0
DevelopersQ = Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",UserId) 
...
Status = 0
Developers = Redis:sismember(Wolf.."Wolf:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(Wolf.."Wolf:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(Wolf.."Wolf:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Wolf.."Wolf:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Wolf.."Wolf:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Wolf.."Wolf:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(Wolf.."Wolf:Developer:Bot:Reply"..ChatId) or 'Myth'
elseif TheBasics then
Status = Redis:get(Wolf.."Wolf:President:Group:Reply"..ChatId) or 'المنشى الاساسي'
elseif Originators then
Status = Redis:get(Wolf.."Wolf:Constructor:Group:Reply"..ChatId) or 'المنشى'
elseif Managers then
Status = Redis:get(Wolf.."Wolf:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Wolf.."Wolf:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif Distinguished then
Status = Redis:get(Wolf.."Wolf:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Wolf.."Wolf:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Wolf.."Wolf:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(Wolf.."Wolf:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(Wolf.."Wolf:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(Wolf.."Wolf:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(Wolf.."Wolf:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(Wolf.."Wolf:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(Wolf.."Wolf:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Wolf.."Wolf:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Wolf.."Wolf:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Wolf.."Wolf:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(Wolf.."Wolf:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(Wolf.."Wolf:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Wolf.."Wolf:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(Wolf.."Wolf:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(Wolf.."Wolf:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(Wolf.."Wolf:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Wolf.."Wolf:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(Wolf.."Wolf:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(Wolf.."Wolf:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Wolf.."Wolf:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(Wolf.."Wolf:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(Wolf.."Wolf:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(Wolf.."Wolf:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Wolf.."Wolf:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(Wolf.."Wolf:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(Wolf.."Wolf:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Wolf.."Wolf:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Wolf.."Wolf:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
kkytmAll = Redis:sismember(Wolf.."Wolf:kkytmAll:Groups",UserId) ,
BanAll = Redis:sismember(Wolf.."Wolf:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(Wolf.."Wolf:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Wolf.."Wolf:SilentGroup:Group"..ChatId,UserId)
}
end
...
Managers = Redis:sismember(Wolf.."Wolf:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Wolf.."Wolf:Addictive:Group"..ChatId,UserId)
channelis = Redis:sismember(Wolf.."Wolf:Managers:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Wolf.."Wolf:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1605449126 then
Status = true
...
JoinChannel = true
local Channel = Redis:get(Wolf..'Wolf:Channel:Join')
if Channel then
...
local msg_id = msg.id
if data.sender.luatele == "messageSenderChat" and Redis:get(Wolf.."Lock:channell"..msg_chat_id) and not msg.channelis then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
Redis:incr(Wolf..'Wolf:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
elseif Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'Myth🎖️'
elseif Redis:sismember(Wolf.."Wolf:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Wolf.."Wolf:Developer:Bot:Reply"..msg.chat_id) or 'Myth'
elseif Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Wolf.."Wolf:President:Group:Reply"..msg.chat_id) or 'المنشى الاساسي'
elseif Redis:sismember(Wolf.."Wolf:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Wolf.."Wolf:Constructor:Group:Reply"..msg.chat_id) or 'المنشى '
elseif Redis:sismember(Wolf.."Wolf:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Wolf.."Wolf:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Wolf.."Wolf:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Wolf.."Wolf:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Wolf) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Wolf.."Wolf:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Wolf.."Wolf:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Wolf.."Wolf:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Wolf.."Wolf:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Wolf.."Wolf:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Wolf) then
return false
end
local floods = Redis:hget(Wolf.."Wolf:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Wolf.."Wolf:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Wolf.."Wolf:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Wolf.."Wolf:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Wolf.."Wolf:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Wolf.."Wolf:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Wolf.."Wolf:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Wolf.."Wolf:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Wolf.."Wolf:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(Wolf.."Wolf:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Wolf.."Wolf:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Wolf.."Wolf:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Wolf.."Wolf:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Wolf.."Wolf:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(Wolf.."Wolf:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Wolf.."Wolf:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Wolf.."Wolf:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Wolf.."Wolf:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Wolf.."Wolf:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Wolf.."Wolf:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(Wolf.."Wolf:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Wolf.."Wolf:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Wolf.."Wolf:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(Wolf.."Wolf:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
Redis:set(Wolf..':toob:Name:'..msg.sender.user_id,NameLUser)
end
end
if msg.content.luatele == "messageContact" and not msg.Distinguished then  -- الجهات
local Contact_Group = Redis:get(Wolf.."Wolf:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(Wolf.."Wolf:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Wolf.."Wolf:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Wolf.."Wolf:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Wolf.."Wolf:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Wolf.."Wolf:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Wolf.."Wolf:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Wolf.."Wolf:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Wolf.."Wolf:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Wolf.."Wolf:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Wolf.."Wolf:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(Wolf.."Wolf:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Wolf.."Wolf:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Wolf.."Wolf:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Wolf.."Wolf:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Wolf.."Wolf:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Wolf..'Wolf:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Wolf.."Wolf:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Wolf.."Wolf:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Wolf.."Wolf:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Wolf.."Wolf:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Wolf.."Wolf:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Wolf.."Wolf:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Wolf.."Wolf:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Wolf.."Wolf:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Wolf..'Wolf:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n• ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(Wolf..'Wolf:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Wolf.."Wolf:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Wolf.."Wolf:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Wolf.."Wolf:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Wolf..'Wolf:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(Wolf..'Wolf:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Wolf.."Wolf:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Wolf.."Wolf:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Wolf.."Wolf:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Wolf.."Wolf:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Wolf.."Wolf:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Wolf.."Wolf:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Wolf.."Wolf:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Wolf.."Wolf:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Wolf..'Wolf:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Wolf.."Wolf:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Wolf.."Wolf:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Wolf.."Wolf:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Wolf.."Wolf:Command:List:Group"..msg_chat_id,text)
...
Redis:del(Wolf.."Wolf:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Wolf.."Wolf:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Wolf.."Wolf:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Wolf.."Wolf:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Wolf.."Wolf:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"• ارسل الامر الجديد ليتم وضعه مكان القديم ","md",true)  
end
if text and Redis:get(Wolf.."Wolf:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Wolf.."Wolf:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Wolf.."Wolf:Command:List:Group"..msg_chat_id,text)
Redis:del(Wolf.."Wolf:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الامر باسم ↢ ( "..text..' ) ',"md",true)
end
if Redis:get(Wolf.."Wolf:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Wolf.."Wolf:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Wolf.."Wolf:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(Wolf.."Wolf:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Wolf.."Wolf:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Wolf.."Wolf:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Wolf.."Wolf:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Wolf.."Wolf:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Wolf.."Wolf:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Wolf.."Wolf:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Wolf.."Wolf:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Wolf.."Wolf:PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Wolf.."Wolf:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Wolf.."Wolf:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(Wolf..'Wolf:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Wolf.."Wolf:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Wolf.."Wolf:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(Wolf.."Wolf:ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Wolf.."Wolf:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Wolf.."Wolf:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Wolf.."Wolf:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر •' then   
Redis:del(Wolf.."Wolf:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(Wolf..'Wolf:GetTexting:DevWolf'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(Wolf..'Wolf:GetTexting:DevWolf'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• اهلا عزيزي , تم الغاء تغيير كليشه Dev🎖')
end
Redis:set(Wolf..'Wolf:Texting:DevWolf',text)
Redis:del(Wolf..'Wolf:GetTexting:DevWolf'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'• تم حفظ كليشة Dev🎖')
end
if Redis:get(Wolf.."Wolf:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء تعيين الايدي عام ","md",true)  
Redis:del(Wolf.."Wolf:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Wolf.."Wolf:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Wolf.."Wolf:Set:Id:all",text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(Wolf.."Wolf:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء تعيين الايدي ","md",true)  
Redis:del(Wolf.."Wolf:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(Wolf.."Wolf:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(Wolf.."Wolf:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(Wolf.."Wolf:Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Wolf.."Wolf:Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء اسم البوت ","md",true)  
end 
Redis:del(Wolf.."Wolf:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(Wolf.."Wolf:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغيير اسم البوت الى • "..text,"md",true)    
end 
if Redis:get(Wolf.."Wolf:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Wolf.."Wolf:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n• اهلا عزيزي , تم الغاء تغيير كليشه start","md",true)  
end 
Redis:del(Wolf.."Wolf:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Wolf.."Wolf:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "• تم تغيير كليشه start • "..text,"md",true)    
end 
if Redis:get(Wolf.."Wolf:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Wolf.."Wolf:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Wolf.."Wolf:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Wolf.."Wolf:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(Wolf.."Wolf:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Wolf.."Wolf:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , تم الغاء الترحيب ","md",true)   
end 
Redis:del(Wolf.."Wolf:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Wolf.."Wolf:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(Wolf.."Wolf:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Wolf.."Wolf:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , تم الغاء القوانين","md",true)   
end 
Redis:set(Wolf.."Wolf:Group:Rules" .. msg_chat_id,text) 
Redis:del(Wolf.."Wolf:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(Wolf.."Wolf:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Wolf.."Wolf:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text == "الغاء" then 
Redis:del(Wolf.."Wolf:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , تم الغاء الرد","md",true)   
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Wolf.."Wolf:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(Wolf.."Wolf:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Wolf.."Wolf:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
print(idPhoto)
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"• اضفت الرد بنجاح \n• ارسل ( "..test.." ) لتشوف الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(Wolf.."Wolf:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Wolf.."Wolf:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(Wolf.."Wolf:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(Wolf.."Wolf:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(Wolf.."Wolf:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(Wolf.."Wolf:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Wolf.."Wolf:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(Wolf.."Wolf:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(Wolf.."Wolf:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Wolf.."Wolf:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود ","md",true)  
return false
end
end
if text and Redis:get(Wolf.."Wolf:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(Wolf.."Wolf:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(Wolf.."Wolf:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Video"..text)
local document = Redis:get(Wolf.."Wolf:Add:Rd:Sudo:File"..text)
local audio = Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(Wolf.."Wolf:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Wolf..'Wolf:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(Wolf..'Wolf:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(Wolf.."Wolf:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(Wolf.."Wolf:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(Wolf.."Wolf:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(Wolf.."Wolf:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(Wolf.."Wolf:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(Wolf.."Wolf:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(Wolf.."Wolf:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(Wolf.."Wolf:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(Wolf.."Wolf:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(Wolf.."Wolf:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(Wolf..'Wolf:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(Wolf.."Wolf:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(Wolf.."Wolf:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(Wolf.."Wolf:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(Wolf.."Wolf:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(Wolf.."Wolf:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(Wolf.."Wolf:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."Wolf:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(Wolf.."Wolf:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(Wolf.."Wolf:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(Wolf.."Wolf:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(Wolf.."Wolf:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(Wolf.."Wolf:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(Wolf.."Wolf:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(Wolf.."Wolf:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(Wolf.."Wolf:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(Wolf.."Wolf:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Wolf.."Wolf:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(Wolf..'Wolf:'..v..text)
end
Redis:del(Wolf.."Wolf:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Wolf.."Wolf:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حذف الرد من الردود العامه","md",true)  
end
end
if Redis:get(Wolf.."Wolf:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"• عذرآ لا يمكنك تخمين عدد اكبر من ال  20  خمن رقم ما بين ال 1 و 20 \n","md",true)  
end 
local GETNUM = Redis:get(Wolf.."Wolf:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Wolf.."Wolf:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Wolf.."Wolf:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"• مبروك فزت معنا وخمنت الرقم الصحيح\n• تم اضافة  5  من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Wolf.."Wolf:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Wolf.."Wolf:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Wolf.."Wolf:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Wolf.."Wolf:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Wolf.."Wolf:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Wolf.."Wolf:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Wolf.."Wolf:Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(Wolf.."Wolf:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Wolf.."Wolf:Game:Riddles"..msg.chat_id) then
Redis:incrby(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Wolf.."Wolf:Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(Wolf.."Wolf:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Wolf.."Wolf:Game:Reflection"..msg.chat_id) then
Redis:incrby(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Wolf.."Wolf:Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(Wolf.."Wolf:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Wolf.."Wolf:Game:Monotonous"..msg.chat_id) then
Redis:incrby(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Wolf.."Wolf:Game:Monotonous"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if Redis:get(Wolf.."Wolf:Game:Difference"..msg.chat_id) then
if text == Redis:get(Wolf.."Wolf:Game:Difference"..msg.chat_id) then
Redis:incrby(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Wolf.."Wolf:Game:Difference"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n• اجابتك صحيحة كفو عليك ","md",true)  
end
end
if text then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(Wolf..'Wolf:Channel:Join:Name')..'', url = 't.me/'..Redis:get(Wolf..'Wolf:Channel:Join')}, },}}
...
Y = Y + 1
Redis:sadd(Wolf..'Wolf:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Wolf.."Wolf:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Wolf.."Wolf:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Wolf.."Wolf:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Wolf.."Wolf:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Wolf.."Wolf:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Wolf.."Wolf:Distinguished:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(Wolf.."Wolf:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Wolf.."Wolf:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Wolf.."Wolf:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Wolf.."Wolf:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Wolf.."Wolf:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(Wolf..'Wolf:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر' then 
Redis:del(Wolf..'Wolf:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,Wolf).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n• البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(Wolf..'Wolf:Channel:Join',ChannelUser) 
Redis:set(Wolf..'Wolf:Channel:Join:Name',UserId_Info.title) 
...
Redis:set(Wolf..'Wolf:Channel:Redis'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Wolf..'Wolf:Channel:Join')
...
download('https://raw.githubusercontent.com/Fawazz77/Rhps/blob/main/Wolf.lua','Wolf.lua')
...
local Groups = Redis:smembers(Wolf..'Wolf:ChekBotAdd')  
local UsersBot = Redis:smembers(Wolf..'Wolf:Num:User:Pv')  
...
local President = Redis:smembers(Wolf.."Wolf:TheBasics:Group"..v)
local Constructor = Redis:smembers(Wolf.."Wolf:Originators:Group"..v)
local Manager = Redis:smembers(Wolf.."Wolf:Managers:Group"..v)
local Admin = Redis:smembers(Wolf.."Wolf:Addictive:Group"..v)
local Vips = Redis:smembers(Wolf.."Wolf:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(Wolf.."Wolf:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(Wolf.."Wolf:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(Wolf.."Wolf:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(Wolf.."Wolf:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(Wolf.."Wolf:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(Wolf.."Wolf:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(Wolf.."Wolf:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(Wolf.."Wolf:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(Wolf.."Wolf:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(Wolf.."Wolf:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(Wolf.."Wolf:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(Wolf.."Wolf:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(Wolf.."Wolf:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Redis:set(Wolf..'Wolf:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'• عدد احصائيات البوت الكامله \n━━━━━\n• عدد المجموعات : '..(Redis:scard(Wolf..'Wolf:ChekBotAdd') or 0)..'\n• عدد المشتركين : '..(Redis:scard(Wolf..'Wolf:Num:User:Pv') or 0)..'',"md",true)  
end
...
if Redis:sismember(Wolf.."Wolf:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Wolf..'Wolf:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'• عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Wolf..'Wolf:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Wolf.."Wolf:ChekBotAdd",msg_chat_id)

Redis:set(Wolf.."Wolf:Status:Link"..msg_chat_id,true) ;Redis:set(Wolf.."Wolf:Status:Id"..msg_chat_id,true) ;Redis:set(Wolf.."Wolf:Status:Reply"..msg_chat_id,true) ;Redis:set(Wolf.."Wolf:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Wolf.."Wolf:Status:BanId"..msg_chat_id,true) ;Redis:set(Wolf.."Wolf:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(Wolf.."Wolf:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Wolf.."Wolf:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Wolf.."Wolf:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Wolf.."Wolf:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if not Redis:get(Wolf.."Wolf:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(Wolf..'Wolf:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Wolf..'Wolf:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Wolf.."Wolf:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
local Texting = {""}
...
Get_Is_Id = Redis:get(Wolf.."Wolf:Set:Id:all") or Redis:get(Wolf.."Wolf:Set:Id:Group"..msg_chat_id)
if Redis:get(Wolf.."Wolf:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Wolf..'Wolf:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(Wolf..'Wolf:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n• ايديه ↢ '..UserId..
...
local TotalMsg = Redis:get(Wolf..'Wolf:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(Wolf..'Wolf:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n[• ايديه ↢ '..UserId..
'\n• معرفه ↢ @'..UserName..
...
if (Redis:get(Wolf.."Wolf:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر' then   
Redis:del(Wolf.."Wolf:AddSudosNew"..msg_chat_id)
...
Redis:set(Wolf.."Wolf:AddSudosNew"..msg_chat_id,true)
...
if not Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(Wolf.."Wolf:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Myth مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله Myth ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Wolf.."Wolf:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Wolf.."Wolf:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Wolf.."Wolf:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله M مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله Myth ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Wolf.."Wolf:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Wolf.."Wolf:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Wolf.."Wolf:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Wolf.."Wolf:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Wolf.."Wolf:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(Wolf.."Wolf:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Myth مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم تنزيله Myth ").Reply,"md",true)  
end
end
...
if not Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Wolf.."Wolf:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Wolf.."Wolf:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(Wolf.."Wolf:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Myth مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Developers:Groups",UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته Myth ").Reply,"md",true)  
end
end
if UserName[1] == "منشئ اساسي" then
...
if Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Wolf.."Wolf:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Wolf.."Wolf:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Wolf.."Wolf:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
Redis:sadd(Wolf.."Wolf:Managers:Group"..msg_chat_id,UserId_Info.id) 
Redis:sadd(Wolf.."Wolf:id:ch",UserId_Info.id) 
...
if Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Wolf.."Wolf:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Myth مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته Myth ").Reply,"md",true)  
end
end
if TextMsg == "منشئ اساسي" then
...
if Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Wolf.."Wolf:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Wolf.."Wolf:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Myth🎖 مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(Wolf.."Wolf:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Myth مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Developers:Groups",UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم ترقيته Myth ").Reply,"md",true)  
end
end
if UserId[1] == "منشئ اساسي" then
...
if Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Wolf.."Wolf:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Wolf.."Wolf:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"• تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Wolf.."Wolf:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Wolf.."Wolf:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Wolf.."Wolf:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Wolf.."Wolf:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Wolf.."Wolf:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Wolf.."Wolf:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Wolf.."Wolf:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Wolf.."Wolf:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Wolf.."Wolf:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Wolf.."Wolf:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Wolf.."Wolf:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Wolf.."Wolf:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Wolf.."Wolf:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Wolf.."Wolf:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Wolf.."Wolf:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Wolf.."Wolf:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Wolf.."Wolf:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Wolf.."Wolf:Status:Id"..msg_chat_id,true) 
...
Redis:set(Wolf.."Wolf:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Wolf.."Wolf:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Wolf.."Wolf:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Wolf.."Wolf:Status:BanId"..msg_chat_id,true) 
...
Redis:set(Wolf.."Wolf:BotFree",true) 
...
Redis:set(Wolf.."Wolf:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(Wolf.."Wolf1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Wolf.."Wolf1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Wolf.."Wolf1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Wolf.."Wolf1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(Wolf.."Wolf1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Wolf..'Wolf1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(Wolf..'Wolf1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(Wolf..'Wolf1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(Wolf.."Wolf1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Wolf.."Wolf1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(Wolf.."Wolf1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(Wolf.."Wolf1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(Wolf.."Wolf1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(Wolf.."Wolf1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(Wolf.."Wolf1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(Wolf.."Wolf1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(Wolf.."Wolf1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Wolf.."Wolf1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."Wolf1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Wolf.."Wolf1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."Wolf1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Wolf.."Wolf1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."Wolf1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Wolf.."Wolf1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."Wolf1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(Wolf.."Wolf1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."Wolf1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Wolf.."Wolf1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."Wolf1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(Wolf.."Wolf1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(Wolf.."Wolf1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(Wolf.."Wolf1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(Wolf.."ardode:List:Rd:Sudo", text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ',"md",true) 
end
end
if text and text:match("^(.*)$") then
if Redis:get(Wolf.."ardode:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text'..text)
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text1'..text)
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text2'..text)
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text3'..text)
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text4'..text)
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text5'..text)
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text6'..text)
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text7'..text)
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text8'..text)
Redis:del(Wolf..'ardode:Add:Rd:Sudo:Text9'..text)
Redis:del(Wolf.."ardode:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(Wolf.."ardode:List:Rd:Sudo", text)
...
local list = Redis:smembers(Wolf.."ardode:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text"..v) 
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text1"..v) 
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text2"..v) 
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text3"..v) 
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text4"..v) 
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text5"..v) 
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text6"..v) 
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text7"..v) 
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text8"..v) 
Redis:del(Wolf.."ardode:Add:Rd:Sudo:Text9"..v) 
Redis:del(Wolf.."ardode:List:Rd:Sudo")
end
...
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(Wolf.."ardode:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text2"..test, text)  
end
...
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd3" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd4')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text3"..test, text)  
end
...
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd4" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd5')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text4"..test, text)  
end
...
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd5" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd6')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text5"..test, text)  
end
...
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd6" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd7')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text6"..test, text)  
end
...
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd7" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd8')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text7"..test, text)  
end
...
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd8" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd9')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text8"..test, text)  
end
...
if text then  
local test = Redis:get(Wolf.."ardode:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd9" then
Redis:set(Wolf.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd10')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("","") 
Redis:set(Wolf.."ardode:Add:Rd:Sudo:Text9"..test, text)  
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text2"..text)
local Text3 = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text3"..text)
local Text4 = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text4"..text)
local Text5 = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text5"..text)
local Text6 = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text6"..text)
local Text7 = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text7"..text)
local Text8 = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text8"..text)
local Text9 = Redis:get(Wolf.."ardode:Add:Rd:Sudo:Text9"..text)   
...
Redis:sadd(Wolf.."Wolf:allM"..msg.chat_id, msg.id)
if Redis:get(Wolf.."Wolf:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(Wolf.."Wolf:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(Wolf.."Wolf:allM"..msg.chat_id)
...
Redis:del(Wolf.."Wolf:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(Wolf.."Wolf:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(Wolf.."Wolf:allM"..msg.chat_id)  
...
Redis:del(Wolf.."Wolf:Status:Del:Media"..msg.chat_id)
...
Redis:set(Wolf.."Wolf:Status:Del:Media"..msg.chat_id,true)
...
Rink = 1
elseif Redis:sismember(Wolf.."Wolf:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Wolf.."Wolf:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Wolf.."Wolf:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Wolf.."Wolf:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Wolf.."Wolf:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Wolf.."Wolf:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Wolf.."Wolf:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
Redis:del(Wolf.."Wolf:Status:joinet"..msg_chat_id) 
...
Redis:set(Wolf.."Wolf:Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'الرابط' then
Redis:del(Wolf.."Wolf:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Wolf.."Wolf:Status:Welcome"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Status:Id"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Status:Reply"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Status:BanId"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Status:SetId"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل الرفع ","md",true)
end
if TextMsg == 'الالعاب' then
Redis:del(Wolf.."Wolf:Status:Games"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل الالعاب ","md",true)
end
if TextMsg == 'اطردني' then
Redis:del(Wolf.."Wolf:Status:KickMe"..msg_chat_id) 
...
if Redis:sismember(Wolf.."Wolf:kkytmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:kkytmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Wolf.."Wolf:kkytmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:kkytmAll:Groups",UserId_Info.id) 
...
if Redis:sismember(Wolf.."Wolf:kkytmAll:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:kkytmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Wolf.."Wolf:kkytmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Wolf.."Wolf:kkytmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Wolf.."Wolf:kkytmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:sadd(Wolf.."Wolf:kkytmAll:Groups",UserId) 
...
if not Redis:sismember(Wolf.."Wolf:kkytmAll:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه عام مسبقاً . ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:kkytmAll:Groups",UserId) 
...
local Info_Members = Redis:smembers(Wolf.."Wolf:kkytmAll:Groups") 
if #Info_Members == 0 then
...
if not Redis:sismember(Wolf.."Wolf:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Wolf.."Wolf:BanAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Wolf.."Wolf:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Wolf.."Wolf:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Wolf.."Wolf:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Wolf.."Wolf:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Wolf.."Wolf:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"• تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(Wolf.."Wolf:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Wolf.."Wolf:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Wolf.."Wolf:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
Redis:set(Wolf.."Wolf:Lock:text"..msg_chat_id,true) 
...
Redis:set(Wolf.."Wolf:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Wolf.."Wolf:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Wolf.."Wolf:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Wolf.."Wolf:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Wolf.."Wolf:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Wolf.."Wolf:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Wolf.."Wolf:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Wolf..'Wolf:'..lock..msg_chat_id,"del")    
end
...
Redis:del(Wolf.."Wolf:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Wolf.."Wolf:Lock:text"..msg_chat_id)  
...
Redis:del(Wolf.."Wolf:Lock:Join"..msg_chat_id)  
...
Redis:del(Wolf.."Wolf:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Wolf.."Wolf:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Wolf.."Wolf:lockpin"..msg_chat_id)  
...
Redis:del(Wolf.."Wolf:Lock:edit"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Wolf..'Wolf:'..lock..msg_chat_id)    
end
...
Redis:hset(Wolf.."Wolf:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Wolf.."Wolf:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Wolf.."Wolf:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Wolf.."Wolf:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Wolf.."Wolf:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Wolf.."Wolf:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Link"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Photo"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Video"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Animation"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:geam"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Audio"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:vico"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Sticker"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:forward"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Document"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Contact"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Spam"..msg_chat_id)  
...
Redis:set(Wolf.."Wolf:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Wolf.."Wolf:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Wolf.."Wolf:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Wolf.."Wolf:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Wolf.."Wolf:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Wolf.."Wolf:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(Wolf.."Wolf:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(Wolf.."Wolf:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Wolf.."Wolf:Group:Link"..msg_chat_id) 
if GetLink then
...
Redis:setex(Wolf.."Wolf:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(Wolf.."Wolf:Status:Welcome"..msg_chat_id) then
...
Redis:del(Wolf.."Wolf:Welcome:Group"..msg_chat_id) 
...
Redis:setex(Wolf.."Wolf:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Wolf.."Wolf:Group:Rules"..msg_chat_id) 
...
local Rules = Redis:get(Wolf.."Wolf:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Wolf.."Wolf:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Wolf.."Wolf:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Wolf.."Wolf:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Wolf.."Wolf:Filter:Group:"..v..msg_chat_id)  
Redis:srem(Wolf.."Wolf:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Wolf.."Wolf:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Wolf..'Wolf:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Wolf..'Wolf:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n• ارسل الان  ملصق ,متحركه ,صوره ,رساله  ',"md",true)  
end
...
Redis:set(Wolf.."Wolf:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Wolf.."Wolf:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Wolf.."Wolf:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Wolf.."Wolf:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(Wolf.."Wolf:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(Wolf.."Wolf:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(Wolf.."Wolf:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Wolf.."Wolf:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Wolf.."Wolf:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Wolf.."Wolf:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Wolf.."Wolf:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Wolf.."Wolf:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Wolf.."Wolf:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Wolf.."Wolf:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Wolf.."Wolf:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(Wolf..'Wolf:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'• تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Wolf..'Wolf:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'• تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Wolf..'Wolf:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'• تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد رسائلك هنا '..(Redis:get(Wolf..'Wolf:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد التعديلات هنا •'..(Redis:get(Wolf..'Wolf:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'• عدد جهاتك المضافه هنا •'..(Redis:get(Wolf.."Wolf:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'',"md",true)  
...
Redis:setex(Wolf.."Wolf:Redis:Id:all"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:setex(Wolf.."Wolf:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
• اهلا عزيزي , يمكنك تعيين الايدي الان
• يمكنك استخدام الدوال الاتية :
• `#اليوزر` ↢ يوزر المستخدم
...
Redis:del(Wolf.."Wolf:Set:Id:all")
...
Redis:del(Wolf.."Wolf:Set:Id:Group"..msg.chat_id)
...
Redis:del(Wolf.."Wolf:DevelopersQ:Groups") 
...
Redis:del(Wolf.."Wolf:Developers:Groups") 
...
Redis:del(Wolf.."Wolf:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Originators:Group"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Managers:Group"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Addictive:Group"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:kkytmAll:Groups") 
...
Redis:del(Wolf.."Wolf:BanAll:Groups") 
...
Redis:del(Wolf.."Wolf:BanGroup:Group"..msg_chat_id) 
...
Redis:del(Wolf.."Wolf:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(Wolf.."Wolf:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(Wolf.."Wolf:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(Wolf.."Wolf:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(Wolf.."Wolf:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(Wolf.."Wolf:List:Manager"..msg_chat_id)
end
...
text = "• قائمه الردود \n━━━━━\n"
for k,v in pairs(list) do
if Redis:get(Wolf.."Wolf:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف • "
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » ( "..v.." ) » ( "..db.." )\n"
end
...
Redis:set(Wolf.."Wolf:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(Wolf.."Wolf:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(Wolf.."Wolf:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Wolf.."Wolf:Add:Rd:Sudo:Gif"..v)   
Redis:del(Wolf.."Wolf:Add:Rd:Sudo:vico"..v)   
Redis:del(Wolf.."Wolf:Add:Rd:Sudo:stekr"..v)     
Redis:del(Wolf.."Wolf:Add:Rd:Sudo:Text"..v)   
Redis:del(Wolf.."Wolf:Add:Rd:Sudo:Photo"..v)
Redis:del(Wolf.."Wolf:Add:Rd:Sudo:Video"..v)
Redis:del(Wolf.."Wolf:Add:Rd:Sudo:File"..v)
Redis:del(Wolf.."Wolf:Add:Rd:Sudo:Audio"..v)
Redis:del(Wolf.."Wolf:Add:Rd:Sudo:video_note"..v)
Redis:del(Wolf.."Wolf:List:Rd:Sudo")
end
...
text = "\n• قائمة الردود العامه \n━━━━━\n"
for k,v in pairs(list) do
if Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Sudo:File"..v) then
db = "ملف • "
elseif Redis:get(Wolf.."Wolf:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(Wolf.."Wolf:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » ( "..v.." ) » ( "..db.." )\n"
end
...
Redis:set(Wolf.."Wolf:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , ارسل الان الرد لأضافته ","md",true)  
end
...
Redis:set(Wolf.."Wolf:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id,"• اهلا عزيزي , ارسل الان الرد لحذفه ","md",true)  
end
...
Redis:setex(Wolf.."Wolf:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
• ارسل لي سواء كان 
...
Redis:setex(Wolf.."Wolf:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯|ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Wolf.."Wolf:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯|ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(Wolf.."Wolf:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Wolf.."Wolf:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Wolf..'Wolf:GetTexting:DevWolf'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Wolf..'Wolf:Texting:DevWolf')
...
Redis:setex(Wolf.."Wolf:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
x = x + 1
Redis:srem(Wolf..'Wolf:Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:srem(Wolf..'Wolf:ChekBotAdd',Get_Chat.id)
...
Redis:srem(Wolf..'Wolf:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
local mony = Redis:get(Wolf.."zrffdcf"..v) or 0
...
if num <= 25 then
fne = Redis:get(Wolf..':toob:Name:'..v[2])
tt =  "["..fne.."]("..fne..")"
local mony = v[1]
local emo = emoji[k]
num = num + 1
...
ballancee = Redis:get(Wolf.."nool:flotysb"..msg.sender.user_id) or 0
local bank_users = Redis:smembers(Wolf.."ttpppi")
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Wolf.."nool:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
local bank_users = Redis:smembers(Wolf.."almtzog"..msg_chat_id)
if #bank_users == 0 then
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Wolf.."mznom"..msg_chat_id..v) 
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(Wolf..msg_chat_id..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
fne = Redis:get(Wolf..':toob:Name:'..zwga_id)
fnte = Redis:get(Wolf..':toob:Name:'..v[2])
...
if Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(Wolf..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(Wolf..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(Wolf..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(Wolf..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(Wolf..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(Wolf..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(Wolf..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(Wolf.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(Wolf.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(Wolf.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(Wolf.."almtzog"..msg_chat_id,msg.sender.user_id)
...
if text == "زواجي" then
if not Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:") and not Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."bnttt2:") then
return LuaTele.sendText(msg_chat_id,msg_id,"انت اعزب","md")
end
if Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(Wolf..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(Wolf..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(Wolf..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• عقد زواجكم\n• الزوج : "..alzog.."\n• الزوجه : "..albnt.." \n• المهر : "..mhrr.." بتكوين ","md")
end
if Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(Wolf..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(Wolf..':toob:Name:'..zwga_id)
albnt = "["..fnte.."](tg://user?id="..zwga_id..") "
local gg = LuaTele.getUser(zoog2)
fntey = Redis:get(Wolf..':toob:Name:'..zoog2)
...
if Redis:sismember(Wolf.."noooybgy",yemsg.sender.user_id) then
cccc = Redis:get(Wolf.."noolb"..yemsg.sender.user_id)
gg = Redis:get(Wolf.."nnonb"..yemsg.sender.user_id)
uuuu = Redis:get(Wolf.."nnonbn"..yemsg.sender.user_id)
pppp = Redis:get(Wolf.."zrffdcf"..yemsg.sender.user_id) or 0
ballancee = Redis:get(Wolf.."nool:flotysb"..yemsg.sender.user_id) or 0
...
if text == "خلع" then
if not Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(Wolf.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(Wolf.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(Wolf.."mznom"..msg_chat_id..zwga_id)
Redis:srem(Wolf.."almtzog"..msg_chat_id,zwga_id)
Redis:del(Wolf.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(Wolf.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(Wolf..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(Wolf..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(Wolf..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(Wolf..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(Wolf..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"• تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." بتكوين","md")
end
if text == "طلاق"  then
if not Redis:get(Wolf..msg_chat_id..msg.sender.user_id.."rgalll2:") then
...
balas = 0
if Redis:sismember(Wolf.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• لديك حساب بنكي مسبقاً\n\n• لعرض معلومات حسابك اكتب\n↤︎ `حسابي`","md",true)
end
Redis:setex(Wolf.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
...
if Redis:get(Wolf.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) then
if text == "بينانس ." then
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
news = ""..ban.first_name..""
...
gg = "والت كارد ."
flossst = Redis:get(Wolf.."nool:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
Redis:set(Wolf.."nonna"..msg.sender.user_id,news)
Redis:set(Wolf.."noolb"..msg.sender.user_id,creditcc)
Redis:set(Wolf.."nnonb"..msg.sender.user_id,text)
Redis:set(Wolf.."nnonbn"..msg.sender.user_id,gg)
Redis:set(Wolf.."nonallname"..creditcc,news)
Redis:set(Wolf.."nonallbalc"..creditcc,balas)
Redis:set(Wolf.."nonallcc"..creditcc,creditcc)
Redis:set(Wolf.."nonallban"..creditcc,text)
Redis:set(Wolf.."nonallid"..creditcc,banid)
Redis:sadd(Wolf.."noooybgy",msg.sender.user_id)
Redis:del(Wolf.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(Wolf.."nonna"..msg.sender.user_id,news)
Redis:set(Wolf.."noolb"..msg.sender.user_id,creditvi)
Redis:set(Wolf.."nnonb"..msg.sender.user_id,text)
Redis:set(Wolf.."nnonbn"..msg.sender.user_id,gg)
Redis:set(Wolf.."nonallname"..creditvi,news)
Redis:set(Wolf.."nonallbalc"..creditvi,balas)
Redis:set(Wolf.."nonallcc"..creditvi,creditvi)
Redis:set(Wolf.."nonallban"..creditvi,text)
Redis:set(Wolf.."nonallid"..creditvi,banid)
Redis:sadd(Wolf.."noooybgy",msg.sender.user_id)
Redis:del(Wolf.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
local banid = msg.sender.user_id
Redis:set(Wolf.."nonna"..msg.sender.user_id,news)
Redis:set(Wolf.."noolb"..msg.sender.user_id,creditex)
Redis:set(Wolf.."nnonb"..msg.sender.user_id,text)
Redis:set(Wolf.."nnonbn"..msg.sender.user_id,gg)
Redis:set(Wolf.."nonallname"..creditex,news)
Redis:set(Wolf.."nonallbalc"..creditex,balas)
Redis:set(Wolf.."nonallcc"..creditex,creditex)
Redis:set(Wolf.."nonallban"..creditex,text)
Redis:set(Wolf.."nonallid"..creditex,banid)
Redis:sadd(Wolf.."noooybgy",msg.sender.user_id)
Redis:del(Wolf.."nooolb" .. msg.chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:sismember(Wolf.."noooybgy",msg.sender.user_id) then
Redis:srem(Wolf.."noooybgy", msg.sender.user_id)
Redis:del(Wolf.."noolb"..msg.sender.user_id)
Redis:del(Wolf.."zrffdcf"..msg.sender.user_id)
Redis:srem(Wolf.."zrfffidtf", msg.sender.user_id)
...
if msg.ControllerBot then
local bank_users = Redis:smembers(Wolf.."noooybgy")
for k,v in pairs(bank_users) do
Redis:del(Wolf.."nool:flotysb"..v)
Redis:del(Wolf.."zrffdcf"..v)
Redis:del(Wolf.."innoo"..v)
Redis:del(Wolf.."nnooooo"..v)
Redis:del(Wolf.."nnoooo"..v)
Redis:del(Wolf.."nnooo"..v)
Redis:del(Wolf.."nnoo"..v)
Redis:del(Wolf.."polic"..v)
Redis:del(Wolf.."ashmvm"..v)
Redis:del(Wolf.."hrame"..v)
Redis:del(Wolf.."test:mmtlkat6"..v)
Redis:del(Wolf.."zahbmm2"..v)
end
Redis:del(Wolf.."ttpppi")
...
ballanceed = Redis:get(Wolf.."nool:flotysb"..Remsg.sender.user_id) or 0
...
if Redis:sismember(Wolf.."noooybgy",msg.sender.user_id) then
cccc = Redis:get(Wolf.."noolb"..msg.sender.user_id)
gg = Redis:get(Wolf.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(Wolf.."nnonbn"..msg.sender.user_id)
pppp = Redis:get(Wolf.."zrffdcf"..msg.sender.user_id) or 0
ballancee = Redis:get(Wolf.."nool:flotysb"..msg.sender.user_id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• الاسم ↢ "..news.."\n• الحساب ↢ `"..cccc.."`\n• بنك ↢ ( "..gg.." )\n• نوع ↢ ( "..uuuu.." )\n• الرصيد ↢ ( "..ballancee.." بتكوين 🪙 )\n• الزرف ( "..pppp.." بتكوين 🪙 )\n-","md",true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
...
if text == 'مضاربه' then
if Redis:get(Wolf.."nnooooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Wolf.."nnooooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:decrby(Wolf.."nool:flotysb"..msg.sender.user_id , ballanceekku)
Redis:setex(Wolf.."nnooooo" .. msg.sender.user_id,1200, true)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
Redis:incrby(Wolf.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
Redis:setex(Wolf.."nnooooo" .. msg.sender.user_id,1200, true)
...
if Redis:get(Wolf.."nnoooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Wolf.."nnoooo" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(Wolf.."xxxr" .. msg.sender.user_id) then
ballanceekk = math.floor(coniss / 100 * 10)
ballanceekkk = math.floor(ballancee + ballanceekk)
Redis:incrby(Wolf.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
Redis:sadd(Wolf.."ttpppi",msg.sender.user_id)
Redis:setex(Wolf.."nnoooo" .. msg.sender.user_id,1200, true)
...
Redis:del(Wolf.."nool:flotysb"..msg.sender.user_id)
...
if text == 'حظ' then
if Redis:get(Wolf.."nnooo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Wolf.."nnooo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:incrby(Wolf.."nool:flotysb"..msg.sender.user_id , math.floor(ballanceek))
Redis:setex(Wolf.."nnooo" .. msg.sender.user_id,200, true)
...
ff = Redis:get(Wolf.."nool:flotysb"..msg.sender.user_id)
...
Redis:decrby(Wolf.."nool:flotysb"..msg.sender.user_id , coniss)
Redis:setex(Wolf.."nnooo" .. msg.sender.user_id,200, true)
ff = Redis:get(Wolf.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:set('Wolf:'..bot_id..'idgem:user'..msg.chat_id_,taha)  
Redis:setex('Wolf:'..bot_id.."gemadd:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 120, true)  
...
Redis:incrby('Wolf:'..bot_id..'add:F'..msg.chat_id_..result.sender_user_id_,F)  
Redis:incrby('Wolf:'..bot_id..'add:Fall'..msg.chat_id_..result.sender_user_id_,F)  
...
local coniss = coniss:gsub('٩','9')
local coniss = tonumber(coniss)
if not Redis:sismember(Wolf.."noooybgy",msg.sender.user_id) then
return LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ","md",true)
end
if Redis:get(Wolf.."polici" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Wolf.."polici" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(Wolf.."transn"..msg.sender.user_id,coniss)
Redis:setex(Wolf.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id,60, true)
LuaTele.sendText(msg.chat_id,msg.id,[[
...
if Redis:get(Wolf.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) then
cccc = Redis:get(Wolf.."noolb"..msg.sender.user_id)
gg = Redis:get(Wolf.."nnonb"..msg.sender.user_id)
uuuu = Redis:get(Wolf.."nnonbn"..msg.sender.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(Wolf.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(Wolf.."transn" .. msg.sender.user_id)
...
if Redis:get(Wolf.."nonallcc"..text) then
local UserNamey = Redis:get(Wolf.."transn"..msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
if ban.first_name then
...
local fsvhhh = Redis:get(Wolf.."nonallid"..text)
local bann = LuaTele.getUser(fsvhhh)
hsabe = Redis:get(Wolf.."nnonb"..fsvhhh)
nouu = Redis:get(Wolf.."nnonbn"..fsvhhh)
...
if Redis:get(Wolf.."hramep" .. UserNameyr) then  
local check_time = Redis:ttl(Wolf.."hramep" .. UserNameyr)
rr = oger(check_time)
...
Redis:incrby(Wolf.."nool:flotysb"..fsvhhh ,UserNameyy)
Redis:decrby(Wolf.."nool:flotysb"..msg.sender.user_id ,UserNamey)
Redis:setex(Wolf.."polici" .. msg.sender.user_id,600, true)
Redis:setex(Wolf.."hramep" ..UserNamey ,600, true)
...
ballancee = Redis:get(Wolf.."nool:flotysb"..bl) or 0
Redis:decrby(Wolf.."nool:flotysb"..bl , ballancee)
LuaTele.sendText(msg.chat_id,msg.id, "*تم تصفيرة بنجاح !*","md",true)
end

if text == 'قرض' or text == 'قرض' then
if Redis:sismember(Wolf.."noooybgy",msg.sender.user_id) then
if Redis:get(Wolf.."nnoo1" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Wolf.."nnoo1" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(Wolf.."xxxr" .. msg.sender.user_id) then
Redis:incrby(Wolf.."nool:flotysb"..msg.sender.user_id , 1000000)
Redis:sadd(Wolf.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ قرض 1000000 بتكوين 💸","md",true)
end
local jjjo = "6000000"
Redis:incrby(Wolf.."nool:flotysb"..msg.sender.user_id , jjjo)
Redis:sadd(Wolf.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." بتكوين 💸","md",true)
Redis:setex(Wolf.."nnoo1" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(Wolf.."noooybgy",msg.sender.user_id) then
if Redis:get(Wolf.."nnoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Wolf.."nnoo" .. msg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• من شوي عطيتك انتظر "..rr.." دقيقة") 
end
if Redis:get(Wolf.."xxxr" .. msg.sender.user_id) then
Redis:incrby(Wolf.."nool:flotysb"..msg.sender.user_id , 3000)
Redis:sadd(Wolf.."ttpppi",msg.sender.user_id)
...
Redis:sadd(Wolf.."ttpppi",msg.sender.user_id)
LuaTele.sendText(msg.chat_id,msg.id,"• خذ ي مطفر "..jjjo.." بتكوين 🪙","md",true)
Redis:setex(Wolf.."nnoo" .. msg.sender.user_id,600, true)
else
LuaTele.sendText(msg.chat_id,msg.id, "• ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(Wolf.."noooybgy",UserId_Info.id) then
ballanceed = Redis:get(Wolf.."nool:flotysb"..UserId_Info.id) or 0
LuaTele.sendText(msg.chat_id,msg.id, "• فلوسه "..ballanceed.." بتكوين 🪙","md",true)
else
...
if Redis:get(Wolf.."polic" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Wolf.."polic" .. msg.sender.user_id)
rr = oger(check_time)
...
if Redis:get(Wolf.."hrame" .. Remsg.sender.user_id) then  
local check_time = Redis:ttl(Wolf.."hrame" .. Remsg.sender.user_id)
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• زارفينه قبلك \n• يمديك تزرفه بعد "..rr.." دقيقة") 
end 
if Redis:sismember(Wolf.."noooybgy",Remsg.sender.user_id) then
ballanceed = Redis:get(Wolf.."nool:flotysb"..Remsg.sender.user_id) or 0
...
local ballanceed = Redis:get(Wolf.."nool:flotysb"..Remsg.sender.user_id) or 0
Redis:incrby(Wolf.."nool:flotysb"..msg.sender.user_id , hrame)
Redis:decrby(Wolf.."nool:flotysb"..Remsg.sender.user_id , hrame)
Redis:sadd(Wolf.."ttpppi",msg.sender.user_id)
Redis:setex(Wolf.."hrame" .. Remsg.sender.user_id,900, true)
Redis:incrby(Wolf.."zrffdcf"..msg.sender.user_id,hrame)
Redis:sadd(Wolf.."zrfffidtf",msg.sender.user_id)
Redis:setex(Wolf.."polic" .. msg.sender.user_id,300, true)
...
Redis:incrby(Wolf.."nool:flotysb"..msg.sender.user_id , F)
local ballancee = Redis:get(Wolf.."nool:flotysb"..msg.sender.user_id) or 0
...
Redis:setex(Wolf.."innoo" .. msg.sender.user_id,600, true)
end
if text == 'راتب' or text == 'راتبي' then
if Redis:sismember(Wolf.."noooybgy",msg.sender.user_id) then
if Redis:get(Wolf.."innoo" .. msg.sender.user_id) then  
local check_time = Redis:ttl(Wolf.."innoo" .. msg.sender.user_id)
rr = oger(check_time)
...
Redis:set(Wolf.."Wolf:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Wolf.."Wolf:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Wolf.."Wolf:Status:Games"..msg.chat_id) then
Redis:del(Wolf.."Wolf:Set:Maany"..msg.chat_id)
...
Redis:set(Wolf.."Wolf:Game:Meaningof"..msg.chat_id,name)
...
if Redis:get(Wolf.."Wolf:Status:Games"..msg.chat_id) then
Redis:del(Wolf.."Wolf:Set:Aks"..msg.chat_id)
...
Redis:set(Wolf.."Wolf:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Wolf.."Wolf:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Wolf.."Wolf:Game:Difference"..msg.chat_id,name)
...
local NumberGame = Redis:get(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Wolf.."Wolf:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Wolf.."Wolf:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Wolf.."Wolf:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'C','رفع C')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(Wolf.."Wolf:Get:Reides:Commands:Group"..msg_chat_id..":"..'CM','رفع CM')
...
if text == '/start' then
Redis:sadd(Wolf..'Wolf:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Wolf.."Wolf:Start:Bot") then
local CmdStart = '\n• أهلآ بك في بوت '..(Redis:get(Wolf.."Wolf:Name:Bot") or "Wolf")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Wolf.."Wolf:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Wolf.."Wolf:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(Wolf.."Wolf:TwaslBot") and not Redis:sismember(Wolf.."Wolf:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Wolf.."Wolf:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Wolf.."Wolf:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Wolf..'Wolf:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'• تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Wolf..'Wolf:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Wolf.."Wolf:ChekBotAdd",'-100'..data.supergroup.id)
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Wolf.."Wolf:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Wolf.."Wolf:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Wolf.."Wolf:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Wolf.."Wolf:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Wolf.."Wolf:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Wolf.."Wolf:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Wolf.."Wolf:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Wolf.."Wolf:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Wolf.."Wolf:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Wolf.."Wolf:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Wolf.."Wolf:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Wolf.."Wolf:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Wolf.."Wolf:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Wolf.."Wolf:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Wolf.."Wolf:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Wolf.."Wolf:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Wolf.."Wolf:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Wolf.."Wolf:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Wolf.."Wolf:Lock:tagservr"..data.message.chat_id) then
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Wolf..'Wolf:Status:joinet'..data.message.chat_id) == 'true' then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:incr(Wolf..'Wolf:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Wolf.."Wolf:Lock:edit"..data.chat_id) then
...
Redis:srem(Wolf.."Wolf:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(Wolf.."Wolf:BanGroup:Group"..ChatId,listYt[2]) 
...
Redis:del(Wolf.."Wolf:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(Wolf.."Wolf1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Wolf.."Wolf:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Wolf.."Wolf:Redis:Id:all"..ChatId..""..IdUser) 
Redis:del(Wolf.."Wolf:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Wolf.."Wolf:Redis:Id:all"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Wolf.."Wolf:Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Wolf.."Wolf1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Wolf.."Wolf:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"• ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Wolf.."Wolf:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"• ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(Wolf.."Wolf:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Wolf.."Wolf:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Wolf.."Wolf:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Wolf.."Wolf:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Wolf.."Wolf:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Wolf.."Wolf:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Wolf.."Wolf:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Wolf.."Wolf:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Wolf.."Wolf:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Wolf..'Wolf:'..lock..UserId[2],"del")    
end
...
local bank_users = Redis:smembers(Wolf.."almtzog"..ChatId)
top_mony = "توب اغنى 10 زوجات بالقروب :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
local mony = Redis:get(Wolf.."mznom"..ChatId..v)
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
for k,v in pairs(mony_list) do
if num <= 10 then
local zwga_id = Redis:get(Wolf..ChatId..v[2].."rgalll2:")
local user_name = LuaTele.getUser(v[2]).first_name
local user_nambe = LuaTele.getUser(zwga_id).first_name
...
ballancee = Redis:get(Wolf.."zrffdcf"..IdUser) or 0
local bank_users = Redis:smembers(Wolf.."zrfffidtf")
top_mony = "توب اكثر 25 شخص حرامية فلوس:\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
ballancee = Redis:get(Wolf.."nool:flotysb"..IdUser) or 0
local bank_users = Redis:smembers(Wolf.."ttpppi")
top_mony = "توب اغنى 25 شخص :\n\n"
mony_list = {}
for k,v in pairs(bank_users) do
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Wolf.."Wolf:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"• تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Wolf.."Wolf:SilentGroup:Group"..ChatId) 
